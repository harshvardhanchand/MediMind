...
def process_document_background(
    ...
    try:
        ...
        doc_repo.update_document_status(document_id, ProcessingStatus.PROCESSING)
        ...
        if not gcs_uri:
            ...
            doc_repo.update_document_status(document_id, ProcessingStatus.FAILED)
            return
        ...
        extracted_data_repo = ExtractedDataRepository(db_session)
        ...
        if not extracted_data:
            ...
            extracted_data = extracted_data_repo.create_initial_extracted_data(document_id)
            if not extracted_data:
        ...
        extracted_data_repo.update_raw_text(document_id, processed_document.text)
        ...
        if not structured_json:
            ...
            doc_repo.update_document_status(document_id, ProcessingStatus.PARTIAL)
            return
        ...
        try:
            ...
            doc_repo.update_document_status(document_id, ProcessingStatus.PROCESSED)
